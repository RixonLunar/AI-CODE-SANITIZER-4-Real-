import type { EcfVec3, Kilometer } from 'satellite.js';
 ...
 */
export declare class EcfPositionCalculator implements Calculator<'ecfPosition', 2, [
    'eci',
    'gmst'
], Float64Array, EcfVec3<Kilometer>> {
